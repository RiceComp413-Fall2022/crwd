...
# need to update
AUDREYS_OPEN_HOURS = {0 : (datetime(2022, 1, 1, 7, 30, 0), datetime(2022, 1, 1, 18, 0, 0)),
              1 : (datetime(2022, 1, 1, 7, 30, 0), datetime(2022, 1, 1, 18, 0, 0)),
              2 : (datetime(2022, 1, 1, 7, 30, 0), datetime(2022, 1, 1, 18, 0, 0)),
